...
export async function StoryHero() {
  ...
  return (
    <>
      ...
      <section
        id="storia"
        className="relative flex min-h-[70svh] items-end overflow-hidden bg-brand-ink text-white sm:min-h-[78svh]"
      >
        <div
          aria-hidden
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-6 pb-14 pt-10 sm:pb-20 sm:pt-14">
